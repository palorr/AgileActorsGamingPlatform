...
import static com.agile.resources.UriPaths.ADMIN_USER_PLAY_URI;

@Controller
public class UserPlayOperationController {
    ...
    @GetMapping(value = ADMIN_USER_PLAY_URI)
    public ModelAndView loadOperations() {
        ModelAndView modelAndView = getModelAndView("user_play_operations");
        modelAndView.addObject(OPERATIONS_DATA, operationsService.fetchPlayOperations());
        return modelAndView;
    }
