    ...
    <form action=${url} name="game" method="post">
        <div class="form-group" >
            <p class="required"> <label for="id_name">Name:</label>
                <input <#if game??>value=${game.getName()}</#if> class="form-control"  id="id_name" maxlength="30" name="name" type="text"  placeholder="Enter name"/></p>
        </div>
        <div class="form-group">
            <p class="required"><label for="id_description">Description:</label>
                <input <#if game??>value=${game.getDescription()}</#if> class="form-control" id="id_description" name="description" type="text" placeholder="Enter description" /></p>
        </div>
        <div class="form-group">
            <p class="required"><label for="id_buy_credits">Buy Credits:</label>
                <input <#if game??>value=${game.getBuy_credits()}</#if> class="form-control" id="id_buy_credits" name="buy_credits" type="number" placeholder="Enter buy credits" /></p>
        </div>
        <div class="form-group">
